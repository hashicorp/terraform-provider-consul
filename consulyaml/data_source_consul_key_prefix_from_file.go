...
func dataSourceConsulKeyPrefixFromFile() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceConsulKeyPrefixReadFile,
...
func dataSourceConsulKeyPrefixReadFile(d *schema.ResourceData, meta interface{}) error {
