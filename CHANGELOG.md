...
* The `consul_acl_token` resource new has a `service_identities`, `node_identities` and `expiration_time` arguments ([#284](https://github.com/hashicorp/terraform-provider-consul/issues/284) and [#287](https://github.com/hashicorp/terraform-provider-consul/issues/287)).
* The `consul_acl_token` datasource now has a `roles`, `service_identities`, `node_identities`  and `expiration_time` attributes ([#284](https://github.com/hashicorp/terraform-provider-consul/issues/284) and [#287](https://github.com/hashicorp/terraform-provider-consul/issues/287)).
