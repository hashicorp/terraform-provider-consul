...
func TestAccConsulConfigEntryServiceResolverEETest(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testConsulConfigEntryServiceResolverEEWithRedirect,
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("consul_config_entry_service_resolver.foo", "subsets.0.name", "v1"),
					resource.TestCheckResourceAttr("consul_config_entry_service_resolver.foo", "subsets.0.filter", "Service.Meta.version == v1"),
					resource.TestCheckResourceAttr("consul_config_entry_service_resolver.foo", "subsets.0.only_passing", "true"),
					resource.TestCheckResourceAttr("consul_config_entry_service_resolver.foo", "subsets.1.name", "v2"),
					resource.TestCheckResourceAttr("consul_config_entry_service_resolver.foo", "subsets.1.filter", "Service.Meta.version == v2"),
					resource.TestCheckResourceAttr("consul_config_entry_service_resolver.foo", "subsets.1.only_passing", "true"),
			...
			{
				Config: testConsulConfigEntryServiceResolverEEWithFailover,
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("consul_config_entry_service_resolver.bar", "subsets.0.name", "v1"),
					resource.TestCheckResourceAttr("consul_config_entry_service_resolver.bar", "subsets.0.filter", "Service.Meta.version == v1"),
					resource.TestCheckResourceAttr("consul_config_entry_service_resolver.bar", "subsets.0.only_passing", "true"),
					resource.TestCheckResourceAttr("consul_config_entry_service_resolver.bar", "subsets.1.name", "v2"),
					resource.TestCheckResourceAttr("consul_config_entry_service_resolver.bar", "subsets.1.filter", "Service.Meta.version == v2"),
					resource.TestCheckResourceAttr("consul_config_entry_service_resolver.bar", "subsets.1.only_passing", "true"),
					...
					//resource.TestCheckResourceAttr("consul_config_entry_service_resolver.bar", "failover.0.subset_name", "*"),
					//resource.TestCheckResourceAttr("consul_config_entry_service_resolver.bar", "failover.0.service", "backend"),
					//resource.TestCheckResourceAttr("consul_config_entry_service_resolver.bar", "failover.0.datacenters", "[\"dc3\", \"dc4\"]"),
					//resource.TestCheckResourceAttr("consul_config_entry_service_resolver.bar", "failover.1.subset_name", "v2"),
					//resource.TestCheckResourceAttr("consul_config_entry_service_resolver.bar", "failover.1.service", "frontend"),
					//resource.TestCheckResourceAttr("consul_config_entry_service_resolver.bar", "failover.1.datacenters", "[\"dc2\"]"),
					//resource.TestCheckResourceAttr("consul_config_entry_service_resolver.bar", "failover.1.subset_name", "v1"),
					//resource.TestCheckResourceAttr("consul_config_entry_service_resolver.bar", "failover.2.targets.#", "1"),
					//resource.TestCheckResourceAttr("consul_config_entry_service_resolver.bar", "failover.2.targets.0.service_subset", "v1"),
					//resource.TestCheckResourceAttr("consul_config_entry_service_resolver.bar", "failover.2.targets.0.datacenter", "dc1"),
					//resource.TestCheckResourceAttr("consul_config_entry_service_resolver.bar", "failover.2.datacenters", "[\"dc2\"]"),
...
const testConsulConfigEntryServiceResolverEEWithRedirect = `
